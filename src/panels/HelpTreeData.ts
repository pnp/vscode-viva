...
export const helpCommands: ActionTreeItem[] = [
    ...
    new ActionTreeItem('Resources & Tooling', '', undefined, TreeItemCollapsibleState.Expanded, undefined, undefined, undefined, [
        ...
        new ActionTreeItem('SPFx Local Workbench', '', { name: 'tools', custom: false }, undefined, 'vscode.open', Uri.parse('https://marketplace.visualstudio.com/items?itemName=m365pnp.pnp-spfx-local-workbench')),
