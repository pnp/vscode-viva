...
![entra app reg manual form](../../../../assets/images-vscode/sign-in-entra-app-reg-form-manual.png)

or automatically by creating the app registration for you with a single click.

![entra app reg form](../../../../assets/images-vscode/sign-in-entra-app-reg-form.png)
