...
This view shows all possible Gulp tasks one may run on an SPFx project. SPFx Toolkit also provides a set of new tasks that are a combination of existing tasks
