...
The extension provides bulk operation capabilities to help you manage multiple SPFx apps efficiently. These operations allow you to perform actions on all apps (or filtered sets) within an app catalog simultaneously.
