...
In case your Nde.js version is not correct or you do not have the required global dependencies installed, SPFx Toolkit will fix that for you by running the install dependencies action.

## Install dependencies

If you are just getting started with SharePoint Framework development on a clean machine you may use the "Install dependencies" button to install all the needed global dependencies in one go without for any version of SPFx.
