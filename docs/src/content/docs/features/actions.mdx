...
![actions](../../../../assets/images-vscode/actions.png)

It is possible to:

## Upgrade project SPFx version

Generates a detailed upgrade report (`.md` and/or code tour) to guide users from their current SPFx version to a selected target version using CLI for Microsoft 365. The report includes both required and optional upgrade steps, with a consolidated script at the end for automated actions and a list of remaining manual steps.

![upgrade-project](../../../../assets/images-vscode/upgrade-project.png)

And the code tour guidance will provide you upgrade tips directly in your code!

![code-tour-upgrade-guidance](../../../../assets/images-vscode/upgrade-project-code-tour.png)
...
![validate-project](../../../../assets/images-vscode/validate-project.png)
...
## Validate local setup for current project

This action will validate the local setup for the currently open SPFx project, ensuring all necessary global dependencies are in place.

![validate-project](../../../../assets/images-vscode/validate-local-setup-for-current-project.png)
...
![rename](../../../../assets/images-vscode/rename.png)
...
![increase-versioning](../../../../assets/images-vscode/increase-versioning.png)
...
![grant-permissions](../../../../assets/images-vscode/grant-permissions.png)
...
![deploy](../../../../assets/images-vscode/deploy.png)
...
![Set form Customizer](../../../../assets/images-vscode/set-form-customizer-action.png)
...
![add-component](../../../../assets/images-vscode/add-component.png)
