---
title: SPFx Toolkit AI capabilities
description: Learn how to use the SPFx Toolkit as a GitHub Copilot chat participant and languages model tools to streamline SharePoint Framework development with predefined commands and AI assistance.
---
...
# SPFx Toolkit Language Model Tools
